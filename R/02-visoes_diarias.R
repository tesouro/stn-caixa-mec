...
mec_simplificado <- read_rds("data/mec_simplificado.rds")

# saldos diários ----------------------------------------------------------
saldos_diarios <- mec_simplificado %>%
...
obrigacoes_a_pagar_diarias <- mec_simplificado %>%
...
# pagamentos diários ----------------------------------------------
pagamentos_diarios <- mec_simplificado %>%
